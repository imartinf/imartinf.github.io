...
antetitulo: Curriculum vitae · updated September 2026
entradilla: PhD in Electronic Systems Engineering from Universidad Politécnica de Madrid. I study how large-scale multimodal models can account for the subjective perception of audiovisual content.
nav: CV
orden: 4
descripcion: Academic CV of Iván Martín-Fernández. GTHAU, ETSIT — Universidad Politécnica de Madrid.
---
<p class="ficha">Early-Career Teaching Track Researcher (PICD) · Dept. of Electronic Engineering, ETSIT — Universidad Politécnica de Madrid · Speech Technology and Machine Learning group (GTHAU) · <a href="mailto:ivan.martinf@upm.es">ivan.martinf@upm.es</a> · ORCID <a href="https://orcid.org/0009-0004-2769-9752">0009-0004-2769-9752</a> · <a href="https://imartinf.github.io">imartinf.github.io</a></p>

<p class="acciones no-print"><button class="boton primario" onclick="window.print()">Export to PDF</button> <a class="boton" href="../cv-es/">Versión en español</a></p>
...
<p class="lede">My research studies the subjective perception of multimedia content: what we remember from
a video, how an advertisement persuades us, and what impression a person leaves when we
watch them speak. I model these phenomena by adapting transformers and multimodal language
models with parameter-efficient techniques, and I contrast them against biological
signals —electroencephalography in particular— to bring prediction closer to mechanism.</p>
...
Universidad Politécnica de Madrid, June 2026. **Summa cum laude** with **international
mention**. Thesis: *Modeling Subjective Perception in Multimedia with Large-Scale Multimodal
Models*. Supervisors: Fernando Fernández-Martínez and Manuel Gil-Martín.

### MSc in Telecommunications Engineering

Universidad Politécnica de Madrid, 2025. GPA 9.04/10 — 96.49th percentile. Distinction in
the master's thesis. **ETSIT 2024 Award for the best MSc thesis of the programme**.

### MSc in Signal Theory and Communications

Universidad Politécnica de Madrid, 2024. GPA 9.62/10 — 93.75th percentile. Distinction in
27 ECTS. **ETSIT-Empresa 2024 Award for the best academic record of the programme**.

### BSc in Telecommunication Technologies and Services Engineering

Universidad Politécnica de Madrid, 2021. GPA 8.03/10 — 93.91st percentile. Distinction in
31.5 ECTS. **ETSIT-Empresa 2021 Award for the best academic record** in the Audiovisual
Systems track.
...
## Teaching
<p class="lede">147 hours taught in official BSc and MSc programmes at ETSIT-UPM between the 2023-24 and
2025-26 academic years.</p>
...
I also take part in two departmental teaching-innovation projects —DEMOSEI (2024) and
DIRASEI (2023)— and co-author five teaching publications derived from them, presented at
END, ICERI and GELS.
...
JCR 6.0 — **Q1**, top 25%. First and corresponding author.
...
R. San-Segundo. *Scientific Data*, 2026. JCR 6.9 — **Q1**, top 25%. Second author.
...
*Multimedia Tools and Applications* 85(1):30, 2026. JCR 3.5 — **Q2**. First and
...
*Sensors* 25(6):1661, 2025. JCR 3.5 — **Q2**. First and corresponding author.
...
## Projects, service and review

::: tarjetas
- **TrustBoost** PID2023-150584OB-C21 · Flexibility and compliance in conversational AI · 2024–2027
- **GOMINOLA** PID2020-118112RB-C22 · Socio-affective conversational agents · 2021–2025
- **MediaEval** Organising committee of the *Predicting Movie and Commercial Memorability* task, with five European institutions · since 2024
- **Review** Reviewer for *npj Artificial Intelligence*
:::

I am first author of the task *overview* papers for the 2025 and 2026 editions, which set
the evaluation framework the participating teams work against.

## Outreach

In September 2026 I taught a two-hour workshop on generative AI for the communications
departments of the eighteen clubs of the Spanish basketball league (ACB), focused on using
these tools without giving up editorial judgement or each club's own identity.
